describe('Component: Invoicing', function() {
  ...
  beforeEach(function() {
    ...
    inject(function($rootScope, $compile, $componentController, _$q_, _invoiceConstants_) {
      scope = $rootScope.$new();
      ...
      invoiceConstants = _invoiceConstants_;
      $q = _$q_;
  ...
  describe('Function: filterHandler', function() {
    it('should fetch active invoices', function() {
      component.filterHandler(true, invoiceConstants.STATUSES.IN_REVIEW.value);
      expect(component.filterBy).toEqual(invoiceConstants.STATUSES.IN_REVIEW.value);
