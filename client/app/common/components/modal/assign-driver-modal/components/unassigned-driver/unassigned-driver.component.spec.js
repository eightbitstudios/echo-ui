...
describe('Component: Unassigned Driver', function () {
  ...
  beforeEach(function () {
    module('app/common/components/modal/assign-driver-modal/components/unassigned-driver/unassigned-driver.component.html');
  ...
  describe('Function: removeDriverCallback', function () {
    it('should call callback and set state', function () {
      ...
      expect(component.selectedDriverCallback).toHaveBeenCalledWith({ driver: null });
  ...
  describe('Function: onSelectCallback', function () {
    it('should call callback and set state', function () {
      var driver = { id: 1234567 };
      component.onSelectCallback(driver);

      expect(component.selectedDriverCallback).toHaveBeenCalledWith({ driver: driver });
