...
$(window).load(function(){
  ...
  ///////////
    ...
    // Invoice Modal Date Picker
    /////////////
    var $idpTrigger = $('.input-modal-dp')

    // Display current date
    $idpTrigger.html(moment().format('MM/DD/YYYY'))
    // Display current time

    $idpTrigger.daterangepicker({
      singleDatePicker: true,
      parentEl: $('.input-modal-dp').closest('.form-group'),
      buttonClasses: "btn",
  ...
  $idpTrigger.on('apply.daterangepicker', function(ev, picker) {
      $(this).val(picker.startDate.format('MM/DD/YYYY'));
  });

  $idpTrigger.on('cancel.daterangepicker', function(ev, picker) {
      $(this).val('');
  });
