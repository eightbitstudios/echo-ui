    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.locale === 'object') {
            ...
            if (typeof options.locale.fromLabel === 'string')
              this.locale.fromLabel = options.locale.cancelLabel;

            if (typeof options.locale.toLabel === 'string')
              this.locale.toLabel = options.locale.applyLabel;
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if (this.showDropdowns) {
                ...
                var monthHtml = '<div class="select monthselect-wrap"><select class="monthselect">';
                for (var m = 0; m < 12; m++) {
                ...
                var yearHtml = '<div class="select  yearselect-wrap"><select class="yearselect">';
